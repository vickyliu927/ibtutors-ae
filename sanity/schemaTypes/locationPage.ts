...
const locationPageSchema = defineType({
  name: 'locationPage',
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'boolean',
      description: 'If enabled, visiting this location page will redirect to the URL below instead of rendering content.',
      initialValue: false,
    }),
    defineField({
    ...
    defineField({
      name: 'title',
      title: 'Title (internal reference only)',
      type: 'string',
      validation: Rule => Rule.required(),
    }),
    defineField({
      ...
      type: 'number',
      description: 'Controls the order in which this location appears in navigation menus and the homepage grid (lower numbers appear first)',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'array',
          of: [{ type: 'string' }],
          description: 'Words in the title that should be highlighted in blue (e.g., "Dubai", "Abu Dhabi")',
        },
        {
          name: 'description',
          title: 'Description',
      ...
      fields: [
        {
          ...
          type: 'string',
          description: 'Orange text shown above the main title for the tutors section on this page (e.g., "Trusted by 15,000+ students across the world"). Leave empty to use the global default.'
        },
        {
        ...
        }),
        {
          ...
          type: 'string',
          description: 'Text that will be displayed as a link',
        },
        {
          name: 'ctaLink',
    ...
    defineField({
      ...
      description: 'Select testimonials specific to this location',
    }),
    defineField({
      name: 'faqSection',
      title: 'FAQ Section',
...
export default addCloneSupport(locationPageSchema)
