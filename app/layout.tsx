  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* TikTok Pixel - TutorChase Pixel (CU379URC77UC5BF3HD80) */}
        <Script id="tiktok-pixel" strategy="afterInteractive">{`
          !function (w, d, t) {
            ...
            ttq.load('CU379URC77UC5BF3HD80');
            ttq.page();
          }(window, document, 'ttq');
        `}</Script>
        {/* TikTok Pixel - SPA navigation tracking */}
        <Script id="tiktok-pixel-route-events" strategy="afterInteractive">{`
          (function() {
            var fire = function() { try { if (window.ttq) window.ttq.page(); } catch (_) {} };
            var origPushState = history.pushState;
            history.pushState = function() {
              var ret = origPushState.apply(this, arguments);
              fire();
