    ...
    return (
      <footer className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-gray-600 text-center">Footer content not available</p>
        </div>
      </footer>
    );
  }
                  ...
                  <React.Fragment key={idx}>
                    ...
                    {idx < arr.length - 1 && (
                      <a
                        ...
                        target="_blank"
                        rel={getServerRelAttributes(footer.tutorchaseLink!)}
                      >
                        TutorChase
                      </a>
                    )}
            ...
            {footer.phone && (
              footer.phoneLink ? (
                <a
                  ...
                  className="flex items-center text-blue-800 hover:text-blue-900"
                  rel={getServerRelAttributes(footer.phoneLink)}
                >
          ...
          <div className="text-gray-500">
            {footer.addressLink ? (
              <a 
                ...
                target="_blank"
                rel={getServerRelAttributes(footer.addressLink)}
              >
                {footer.address}
              </a>
            ) : (
