            ...
            >
              ...
              {showSubjectsDropdown && (
                (() => {
                  ...
                  return (
                    <div className="absolute top-full left-0 mt-1 w-auto inline-block bg-white border border-gray-200 rounded-md shadow-lg py-2 z-30 grid grid-cols-1 gap-1">
                      {filteredSubjects.map((subject) => (
                        subject.externalRedirectEnabled && subject.externalRedirectUrl ? (
                          <ExternalLink key={`${subject.subject}-external`} href={subject.externalRedirectUrl} className="block px-2 py-1 text-sm text-gray-700 hover:bg-gray-100 whitespace-nowrap">
                            {subject.subject}
                          </ExternalLink>
                          ...
                          <Link
                            ...
                            className="block px-2 py-1 text-sm text-gray-700 hover:bg-gray-100 whitespace-nowrap"
                          >
                            {subject.subject}
                          </Link>
                        ) : null
