            ...
            <div key={tutor._id} className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 flex flex-col" style={{ clipPath: 'inset(0)' }}>
              ...
              <div className="flex">
                  ...
                  <div className="flex-1 p-4 pb-2">
                    ...
                    <div className="flex flex-nowrap items-start gap-1 mb-1 overflow-hidden">
                      <p className="font-medium text-gray-600 mr-1 whitespace-nowrap flex-shrink-0 mt-0.5" style={{ fontSize: '0.9rem' }}>Teaches:</p>
                      <div className="flex flex-wrap gap-1 overflow-hidden">
                        <span className={`text-blue-800 font-medium bg-blue-50 px-2 py-0.5 rounded-md inline-flex ${
                        ...
                        {tutor.specialization.additionalSubjects && tutor.specialization.additionalSubjects.length > 1 && (
                          <span className="text-blue-600 font-medium whitespace-nowrap" style={{ fontSize: '0.9rem' }}>
                    ...
                    {tutor.price && (
                      <div className="flex items-center mt-0">
                        <p className="font-medium text-gray-600 whitespace-nowrap mr-1" style={{ fontSize: '0.9rem' }}>Rate:</p>
                        <p className="text-blue-800 font-medium" style={{ fontSize: '0.9rem' }}>
                ...
                {tutor.rating || tutor.activeStudents || tutor.totalLessons || (tutor.languagesSpoken && tutor.languagesSpoken.length > 0) ? (
                        ...
                        <div className="flex w-full mb-1.5">
                          ...
                          {tutor.rating && (
                            <div className="flex items-center mr-2 w-1/2">
                              ...
                              <span className="font-medium" style={{ fontSize: '0.8rem' }}>{tutor.rating}</span>
                              {tutor.reviewCount && (
                                <span className="text-gray-600 ml-1" style={{ fontSize: '0.8rem' }}>({tutor.reviewCount})</span>
                              )}
                            </div>
                          )}
                          ...
                          {tutor.activeStudents && (
                            <div className="flex items-center w-1/2">
                              <svg className="w-3.5 h-3.5 text-blue-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                              </svg>
                              <span className="font-medium" style={{ fontSize: '0.8rem' }}>{tutor.activeStudents}</span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex w-full">
                          ...
                          {tutor.totalLessons && (
                            <div className="flex items-center mr-2 w-1/2">
                              ...
                              <span className="font-medium" style={{ fontSize: '0.8rem' }}>{tutor.totalLessons}</span>
                            </div>
                          )}
                          ...
                          {tutor.languagesSpoken && tutor.languagesSpoken.length > 0 && (
                            <div className="flex items-center w-1/2">
                              <svg className="w-3.5 h-3.5 text-purple-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M7 2a1 1 0 011 1v1h3a1 1 0 110 2H9.578a18.87 18.87 0 01-1.724 4.78c.29.354.596.696.914 1.026a1 1 0 11-1.44 1.389c-.188-.196-.373-.396-.554-.6a19.098 19.098 0 01-3.107 3.567 1 1 0 01-1.334-1.49 17.087 17.087 0 003.13-3.733 18.992 18.992 0 01-1.487-2.494 1 1 0 111.79-.89c.234.47.489.928.764 1.372.417-.934.752-1.913.997-2.927H3a1 1 0 110-2h3V3a1 1 0 011-1zm6 6a1 1 0 01.894.553l2.991 5.982a.869.869 0 01.02.037l.99 1.98a1 1 0 11-1.79.895L15.383 16h-4.764l-.724 1.447a1 1 0 11-1.788-.894l.99-1.98.019-.038 2.99-5.982A1 1 0 0113 8zm-1.382 6h2.764L13 11.236 11.618 14z" clipRule="evenodd" />
                              </svg>
                              <span className="font-medium" style={{ fontSize: '0.8rem' }}>{tutor.languagesSpoken.length}</span>
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <div className="hidden md:flex items-stretch overflow-hidden">
                ...
                <div className="flex-1 p-5 pt-0 mt-3">
                  <div className="flex justify-between items-start mb-1">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {tutor.price && (
                          <div className="flex items-center">
                            <p className="font-medium text-gray-600 whitespace-nowrap mr-1 text-sm">Rate:</p>
                      ...
                      <div className="flex flex-wrap mb-1">
                        {tutor.rating && (
                          <div className="flex items-center mr-4">
                            ...
                            {tutor.reviewCount && (
                              <span className="text-gray-500 ml-1 text-sm">({tutor.reviewCount} reviews)</span>
                            )}
                          </div>
                        )}
                        ...
                        {tutor.activeStudents && (
                          <div className="flex items-center mr-4">
                            ...
                            <span className="font-medium text-sm">{tutor.activeStudents} active students</span>
                          </div>
                        )}
                        ...
                        {tutor.totalLessons && (
                          <div className="flex items-center">
                            ...
                            <span className="font-medium text-sm">{tutor.totalLessons} lessons</span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex justify-between items-center mb-0 pb-0">
                        ...
                        {/* Hire button section with consistent spacing */}
                        <div className="flex-shrink-0 flex flex-col items-end">
                          ...
                          {/* Fixed height container for price tag to maintain spacing */}
                  ...
                  <p className="text-gray-600 mb-0 text-justify mt-0 pt-0 pb-0 px-0" style={{ fontSize: '0.9rem', marginTop: '-5px' }}>{tutor.experience}</p>
